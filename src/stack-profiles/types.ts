...
export interface StackProfile {
   ...
   * One of the SUPPORTED_STACK_PROFILE_IDS.
   */
  id: SupportedStackProfileId;
...
export const SUPPORTED_STACK_PROFILE_IDS = [
  'go',
  'go-node',
  'go-node-python',
  'go-python',
...
export type SupportedStackProfileId = (typeof SUPPORTED_STACK_PROFILE_IDS)[number];

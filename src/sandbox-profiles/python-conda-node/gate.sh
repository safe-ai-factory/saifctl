#!/bin/bash
# python-conda-node sandbox profile — default gate script.
...
# Common options: pytest, python -m pytest, ruff check ., etc.
set -euo pipefail
cd /workspace
...
echo "[factory-gate] WARNING: The python-conda-node profile has no default gate."

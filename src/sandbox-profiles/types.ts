 ...
 *
 * Controls the default coder image (shared by coder and staging containers), startup script,
 * and stage script used by the orchestrator. Each setting can be overridden individually
...
export interface SandboxProfile {
  ...
  /**
   * Default Docker image tag for the coder and staging containers.

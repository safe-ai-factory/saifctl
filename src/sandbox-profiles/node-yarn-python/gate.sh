#!/bin/bash
# node-yarn-python sandbox profile — default gate script.
...
# Common options: yarn test, yarn run lint, etc.
set -euo pipefail
cd /workspace
...
echo "[factory-gate] WARNING: The node-yarn-python profile has no default gate."

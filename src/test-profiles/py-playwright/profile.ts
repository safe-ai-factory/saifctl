 ...
 * Identical to the py-pytest hook — ruff works on any Python file regardless
 * of whether it imports playwright. Skips silently if ruff is not on PATH.
 */
function pyPlaywrightValidateFiles(opts: ValidateFilesOpts): void {
...
export const pyPlaywrightProfile: TestProfile = {
  id: 'py-playwright',
  language: 'Python',
  ...
  validateFiles: pyPlaywrightValidateFiles,
};

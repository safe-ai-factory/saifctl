...
<DocCodeBlock lang="json" code="" />
...
See [Staleness tracking](/product/saifdocs/concepts/staleness-tracking) for a deeper look at how `saifdocs update` and `saifdocs validate` use this mechanism, including how to wire `saifdocs validate` into CI to catch drift before it reaches production.
...
For the full picture of how the manifest feeds into the generation pipeline, see [The generation pipeline](/product/saifdocs/concepts/generation-pipeline).
